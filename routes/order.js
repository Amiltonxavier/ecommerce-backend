...
const { create, listOrders, getStatusValues, orderById, updateOrderStatus, orderByIdUser } = require("../controllers/order");
...
router.get("/order/getsorderById/:ids", orderByIdUser )
